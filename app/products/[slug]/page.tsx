...
export default async function ProductPage({ params }: Props) {
  ...
  const res = await fetch(
    ` https://logged-dolls-souls-abstracts.trycloudflare.com/api/products-lists?filters[slug][$eq]=${slug}&populate=*`,
    { cache: "no-store" }
  );
      ...
      <div
        ...
        style={{
          backgroundImage: product.background?.url
            ? `url( https://logged-dolls-souls-abstracts.trycloudflare.com${product.background.url})`
            : undefined,
        }}
      ></div>
          ...
          <div className="flex justify-center items-center">
            {product.image?.url ? (
              <img
                ...
                src={` https://logged-dolls-souls-abstracts.trycloudflare.com${product.image.url}`}
              />
            ) : (
